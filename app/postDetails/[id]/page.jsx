                                                            ...
                                                            return (
                                                                <section className="w-full flex-col flex gap-1 bg-white">
                                                                    <div className="flex justify-start gap-2 items-center">
                                                                        <button onClick={() => router.push(`/profile/${comment?.userId}`)}> <Image src={user?.userImage ? user.userImage : profileLogo} width={30} height={30} className="h-8 rounded-full w-8" /></button>
