...
const Context = ({ children }) => {
    ...
    const deleteSavedPosts = async (id) => {
        await deleteDoc(doc(db, 'users', `${currentUser?.uid}`, id))
    }
    ...
    return (
        <BlogContext.Provider value={{ posts, pop, setPop,deleteSavedPosts, userPosts, setUserPosts,getBlogUserPosts,getCommentsPosts, commentsPosts, likedPosts, getlikesPosts, following, blogUser, savedPosts, users, currentUser, setCurrentUser, loading, setLoading,getAllPosts }}>
            {
